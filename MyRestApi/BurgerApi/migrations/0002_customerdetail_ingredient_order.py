# Generated by Django 3.1.2 on 2022-01-19 03:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('salad', models.IntegerField(blank=True, max_length=100)),
                ('cheese', models.IntegerField(blank=True, max_length=100)),
                ('meat', models.IntegerField(blank=True, max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
